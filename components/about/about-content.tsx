    ...
    <>
        ...
        <div className="container-page text-center">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              ...
              return (
                <article key={name as string} className="rounded-xl border border-border bg-card p-6">
      ...
      <section className="section-pad border-t border-border bg-card">
        <div className="container-page mx-auto max-w-3xl">
          <p className="text-center text-sm font-medium uppercase tracking-[0.16em] text-rose">
            Questions, answered
          </p>
          <h2 className="mt-3 text-center font-display text-4xl text-ink sm:text-5xl">
