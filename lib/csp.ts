...
export function buildContentSecurityPolicy(input: {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://*.supabase.co https://*.googleapis.com https://*.gstatic.com https://*.google.com https://*.googleusercontent.com",
    ...
    "frame-src 'self' https://checkout.paystack.com https://*.paystack.com https://accounts.google.com https://www.google.com https://maps.google.com https://*.google.com",
    "child-src 'self' https://www.google.com https://maps.google.com https://*.google.com https://checkout.paystack.com https://*.paystack.com",
